...
//        dates: List<String>,
//        futureShortName: String
//    ): Single<MutableList<FuturePosition>> =
//        networkChecker.isConnect().flatMap {
//            println("!!!" + 1)
//            if (it) {
//                val listFuturePosition = mutableListOf<FuturePosition>()
//                println("!!!" + dates.size)
//                for(date in dates) {
//                    println("!!!" + "n")
//                    listFuturePosition.add(apiMoex.getFuturePosition(date, futureShortName)[0])
//                }
//                Single.fromCallable { return@fromCallable listFuturePosition}
//                } else {
//                Single.fromCallable { return@fromCallable mutableListOf<FuturePosition>() }
//            }
//        }.subscribeOn(Schedulers.io())
